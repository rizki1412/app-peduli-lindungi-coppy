    ...
    <View style={styles.bgMainApp}>
      ...
      <View style={styles.row1}>
        <View style={styles.column}>
          ...
          <Text style={styles.tulisan}>Travel</Text>
          <Text style={styles.tulisan1}>Regulations</Text>
        </View>
        <View style={styles.column}>
          <TouchableOpacity
            onPress={() =>
        ...
        <View style={styles.column}>
          ...
          <Text style={styles.tulisan}>Healthcare</Text>
          <Text style={styles.tulisan1}>Facility</Text>
        </View>
      </View>
      <View style={styles.row1}>
        <View style={styles.column}>
        ...
        <View style={styles.column}>
          ...
          <Text style={styles.tulisan}>Find Hospital</Text>
          <Text style={styles.tulisan1}>Bed</Text>
        </View>
